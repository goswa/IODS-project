...
* Since the PC1 corresponds to maternal mortality rate, the Caption for PC1 can be "Health". 

* The caption for PC2 can be 'Knowledge'as second dimension corresponds to life expectancy and expected years of schooling.

* Health and knowledge are both corelated, the countries where women are more educated has more life expectancy and less maternal mortality rate.
